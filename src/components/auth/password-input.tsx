...
const inputClass =
  "w-full rounded-[var(--radius-sm)] border border-[color:var(--line)] bg-[rgba(0,0,0,0.22)] px-3 py-3 pr-24 text-sm outline-none transition focus:border-[rgba(64,224,208,0.58)]";
