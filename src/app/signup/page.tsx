...
export default async function SignupPage({
  ...
  return (
    <AuthShell
      title="Criar conta"
      subtitle="Comece com um espaço privado para acompanhar fontes, sinais e oportunidades do Instagram."
      error={error}
      footerHref="/login"
      footerLabel="Entrar"
    ...
    >
      <form action={signupAction} className="grid gap-4">
        ...
        <label className="grid gap-2 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
          nome do espaço
          <input className={authInputClass} name="workspaceName" type="text" defaultValue="Meu Espaço" required />
        </label>
